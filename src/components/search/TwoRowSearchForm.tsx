...
import { MatchLogicType, TwoRowSearchParams } from '@/hooks/useTwoRowSearch';
...
export function TwoRowSearchForm({ lottoTypes, games, gamesByType, onSearch, isSearching }: TwoRowSearchFormProps) {
    ...
    <Card>
      <CardContent className="pt-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium mb-2">
              Second Row Numbers (Enter numbers for the next draw)
            </label>
            <div className="grid grid-cols-5 md:grid-cols-10 gap-2">
